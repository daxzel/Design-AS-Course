...
<h2><%=name%> новой группы товаров</h2>

<form:form method="post" action="/groups/" commandName="group" class="ym-form ">

	<form:hidden path="key"/>

	<div class="ym-fbox-text">
		<form:label path="NCP">ОКП<sup
				class="ym-required" title="Это поле обязательно.">*</sup>
		</form:label>
		<form:input path="NCP" size="10" />
	</div>
	<div class="ym-fbox-text">
		<form:label path="name">Название группы<sup
				class="ym-required" title="Это поле обязательно.">*</sup>
		</form:label>
